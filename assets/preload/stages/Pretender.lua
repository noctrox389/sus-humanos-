...
function onCreate()
	...
	makeLuaSprite('sky','Mira/pretender/bg sky', -1200, -50)
	scaleObject('sky', 3.1, 3.1);
	makeLuaSprite('what is thits','Mira/what is thist', -300, 0)
	...
	makeLuaSprite('darkSC','Mira/pretender/lightingpretender', -250, -100)
	addLuaSprite('darkSC')
	setObjectCamera('darkSC', 'hud');
	scaleObject('darkSC', 5, 5);
